...
constructor(props) {
  ...
  try {
    ...
    let response = await fetch(
      'api.openweathermap.org/data/2.5/weather?lat=' + this.state.lat + '&lon=' + this.state.long + '&appid=2e62f78ca2aa2fd0c2a9eef06bd7cea6&units=metric'
    );
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.box4}>
        ...
        <View style={styles.iconContainer}>
          ...
          <Text style={{padding: 2}}> Pressure : { this.state.forecast.pressure} </Text>
        </View>
        <View style={styles.button}>
        <View style={styles.iconContainer}>
